...
class DevOpsLoop:
    ...
    async def _observe(self) -> Dict[str, Any]:
        ...
        backend_checks = [
            self._check_backend("brainops-ai-agents", BRAINOPS_API),
            self._check_backend("brainops-backend", BRAINOPS_BACKEND),
            self._check_backend("mcp-bridge", MCP_BRIDGE),
        ]
        ...
        # Check frontends
        frontend_checks = [
            self._check_frontend("myroofgenius", MRG_URL),
            self._check_frontend("weathercraft-erp", ERP_URL),
        ]
        ...
        # Check agent system
        observations["agents"] = await self._check_agents()
    ...
    async def _check_backend(self, name: str, url: str) -> Dict[str, Any]:
    ...
    async def _orient(self, observations: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        if agents.get("success_rate", 100) < 80:
            anomalies.append({
                "type": "agent_degraded",
                "system": "agents",
                "severity": "warning",
