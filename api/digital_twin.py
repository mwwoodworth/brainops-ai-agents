...
async def list_twins():
    ...
    try:
        ...
        if not twins_list:
            import os
            db_url = os.getenv("DATABASE_URL") or os.getenv("SUPABASE_DB_URL") or "postgresql://postgres.yomagoqdmxszqtdwuhab:REDACTED_SUPABASE_DB_PASSWORD@aws-0-us-east-2.pooler.supabase.com:5432/postgres"
            if db_url:
                try:
                    import asyncpg
