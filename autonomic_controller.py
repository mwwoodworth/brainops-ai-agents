...
# Database configuration - uses centralized helper with DATABASE_URL support
try:
    from db_config_helper import get_db_config, DB_CONFIG
except ImportError:
    ...
    def get_db_config():
        ...
        return {'host': db_host, 'database': db_name, 'user': db_user, 'password': db_password, 'port': int(db_port)}
