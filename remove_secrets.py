...
def remove_secrets_from_file(filepath):
    ...
    replacements = [
        # Database password
        (r'"password":\s*"REDACTED_SUPABASE_DB_PASSWORD"', '"password": os.getenv("DB_PASSWORD")'),
        (r"'password':\s*'REDACTED_SUPABASE_DB_PASSWORD'", "'password': os.getenv('DB_PASSWORD')"),
        (r'password\s*=\s*["\']REDACTED_SUPABASE_DB_PASSWORD["\']', 'password=os.getenv("DB_PASSWORD")'),
        ...
        (r'os\.getenv\(["\']DB_PASSWORD["\']\s*,\s*["\']REDACTED_SUPABASE_DB_PASSWORD["\']\)', 'os.getenv("DB_PASSWORD")'),
