...
- .env:16 [DB password literal] DB_PASSWORD=Brain0ps2O2S
- .env:18 [DB password literal] DATABASE_URL=postgresql://postgres.yomagoqdmxszqtdwuhab:Brain0ps2O2S@aws-0-us-east-2.pooler.supabase.com:5432/postgres
- .env.local:9 [DB password literal] DB_PASSWORD=Brain0ps2O2S
- .env.local:11 [DB password literal] DATABASE_URL=postgresql://postgres.yomagoqdmxszqtdwuhab:Brain0ps2O2S@aws-0-us-east-2.pooler.supabase.com:5432/postgres
...
- .env.production:8 [DB password literal] DB_PASSWORD=Brain0ps2O2S
...
- AGENT_ACTIVATION_REPORT.md:327 [DB password literal] PGPASSWORD=Brain0ps2O2S psql -h aws-0-us-east-2.pooler.supabase.com \
- AUREA_INTEGRATION_PATCH.md:140 [API key literal] -H "X-API-Key: brainops_prod_key_2025" \
- BRAIN_ENHANCEMENTS.md:354 [DB password literal] DB_PASSWORD=Brain0ps2O2S
- BRAIN_ENHANCEMENT_SUMMARY.txt:156 [DB password literal] DB_PASSWORD=Brain0ps2O2S
...
- EMBEDDED_MEMORY_SYNC_FIX.md:213 [DB password literal] Password: Brain0ps2O2S
- MCP_ENHANCEMENTS_V2.md:550 [MCP key literal] MCP_API_KEY=brainops_mcp_2025
- SELF_HEALING_QUICK_REFERENCE.md:124 [DB password literal] export DB_PASSWORD="Brain0ps2O2S"
- SELF_HEALING_UPGRADE_DOCS.md:360 [DB password literal] export DB_PASSWORD="Brain0ps2O2S"
- UPGRADE_SUMMARY.md:208 [DB password literal] export DB_PASSWORD="Brain0ps2O2S"
...
- api/ui_testing.py:31 [DB password literal] "password": "Brain0ps2O2S",
...
- database/sync_pool.py:22 [DB password literal] "password": "Brain0ps2O2S",
...
- docs/BRAINOPS_DEVOPS_SOP.md:83 [DB password literal] PGPASSWORD=Brain0ps2O2S psql \
...
- docs/BRAINOPS_DEVOPS_SOP.md:211 [DB password literal] PGPASSWORD=Brain0ps2O2S psql -h aws-0-us-east-2.pooler.supabase.com ...
...
- render.yaml:21 [DB password literal] value: Brain0ps2O2S
...
- self_healing_recovery.py:42 [DB password literal] "password": os.getenv("DB_PASSWORD", "Brain0ps2O2S"),
- setup_consciousness_db.py:5 [DB password literal] DB_URL = "postgresql://postgres.yomagoqdmxszqtdwuhab:Brain0ps2O2S@aws-0-us-east-2.pooler.supabase.com:5432/postgres"
- test_consciousness_loop.py:10 [DB password literal] os.environ["DB_PASSWORD"] = "Brain0ps2O2S"
- test_memory_sync_production.sh:5 [API key literal] API_KEY="brainops_prod_key_2025"
- verify_production.py:11 [DB password literal] os.environ["DB_PASSWORD"] = "Brain0ps2O2S"
- verify_production.py:13 [DB password literal] os.environ["DATABASE_URL"] = "postgresql://postgres.yomagoqdmxszqtdwuhab:Brain0ps2O2S@aws-0-us-east-2.pooler.supabase.com:5432/postgres"
- verify_system.py:18 [DB password literal] 'password': os.getenv('DB_PASSWORD', 'Brain0ps2O2S'), # Using the one from context
